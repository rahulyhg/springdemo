...
@Entity
public class WeeklyRashifalModel {
	@Id
	private int id;
	...
	public WeeklyRashifalModel(int id, String rashifal, int year, int month, int day) {
		super();
		this.id = id;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		WeeklyRashifalModel other = (WeeklyRashifalModel) obj;
		if (day != other.day)
			return false;
		if (id != other.id)
			return false;
